...
class TestHashBlock:
    ...
    def test_hash_block_format(self):
        ...
        block_hash = hash_block("poll1", "voter123", "choice_a", timestamp, "prev_hash", 42)
...
class TestComputeNonce:
    ...
    def test_compute_nonce_easy_difficulty(self):
        ...
        nonce = compute_nonce(
            "poll1", "voter123", "choice_a", timestamp, "prev_hash", 
    ...
    def test_compute_nonce_timeout(self):
        ...
        nonce = compute_nonce(
            "poll1", "voter123", "choice_a", timestamp, "prev_hash",
            difficulty_bits=24, timeout=0.01  # Very short timeout
        )
        end_time = time.time()
    ...
    def test_compute_nonce_produces_valid_pow(self):
        ...
        nonce = compute_nonce(
            "poll1", "voter123", "choice_a", timestamp, "prev_hash",
            difficulty_bits=difficulty_bits, timeout=10.0
        )
        ...
        is_valid = verify_pow(
            "poll1", "voter123", "choice_a", timestamp, "prev_hash", nonce,
...
class TestVerifyPow:
    ...
    def test_verify_pow_valid(self):
        ...
        nonce = compute_nonce(
            "poll1", "voter123", "choice_a", timestamp, "prev_hash",
            difficulty_bits=6, timeout=10.0
        )
    ...
    def test_verify_pow_invalid(self):
        ...
        is_valid = verify_pow(
            "poll1", "voter123", "choice_a", timestamp, "prev_hash", 0,
