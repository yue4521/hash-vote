...
def hash_block(poll_id: str, voter_hash: str, choice: str, 
               timestamp: datetime, prev_hash: str, nonce: int) -> str:
    """
...
def compute_nonce(poll_id: str, voter_hash: str, choice: str,
                  timestamp: datetime, prev_hash: str,
                  difficulty_bits: int = 18, timeout: Optional[float] = None) -> Optional[int]:
    """
...
def verify_pow(poll_id: str, voter_hash: str, choice: str,
               timestamp: datetime, prev_hash: str, nonce: int,
               difficulty_bits: int = 18) -> bool:
    """
